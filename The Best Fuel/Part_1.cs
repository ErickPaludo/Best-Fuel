...
namespace Best_Fuel
{
    class Part_1
    {
        ...
        public double Combustivel, Preço_0, Preço_1, Média, Tanque, Pedagio;

        public Part_1(double média, double preço, int distancia, double tanque,double pedagio)
        {
            Pedagio = pedagio;
            Tanque = tanque;
            Média = média;
            ...
            Preço_0 = (Combustivel * preço) + pedagio;
            Preço_1 = Preço_0 * 2;
